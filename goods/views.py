...
"""
from django.core.paginator import Paginator  # paginator分页器
...
def goods(request):
    """商品分页展示页面"""
    cag_id = request.GET.get('cag', 1)  # 获取当前分类
    ...
    page_data = paginator.page(page_id)  # 获取当前页码数据
    categories = GoodsCategory.objects.all()  # 查询商品分类
